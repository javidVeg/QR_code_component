    ...
    return (
        <>
            <div className=" h-auto p-4 bg-white rounded-lg">
                ...
                <p className="w-52 text-11px font-outfit  text-Grayish-blue px-3 pt-2 ">Scan the QR code to visit Frontend Mentor and take your coding skills to the next level</p>
            </div>
        </>
    )
}
